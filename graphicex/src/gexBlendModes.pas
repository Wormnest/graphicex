...
// Support for blending 8 bit gray with alpha
type
  TGrayAlpha = Word;
  PGrayAlpha = ^TGrayAlpha;

  TGrayBlendMode = class
    procedure NormalBlend(F: TGrayAlpha; var B: TGrayAlpha; MasterAlpha: Byte);
  end;

var
  GrayBlendMode: TGrayBlendMode;

// Support for blending 8 bit indexed with alpha
type
  TIndexedAlpha = Word;
  PIndexedAlpha = ^TIndexedAlpha;

  TIndexedBlendMode = class
    procedure NormalBlend(F: TIndexedAlpha; var B: TIndexedAlpha; MasterAlpha: Byte);
  end;

var
  IndexedBlendMode: TIndexedBlendMode;
...
//-- TGrayBlendMode functions  -------------------------------------------------

procedure TGrayBlendMode.NormalBlend(F: TGrayAlpha; var B: TGrayAlpha; MasterAlpha: Byte);
var
  aMaster        : Byte;
  fAlpha, bAlpha : Byte;
  fGray, bGray   : Byte;
...
begin
  ...
  // The reason to leave it in is probably that it's part of the general
  // computation of a lot of the different blend modes.
...
//-- TIndexedBlendMode functions  -------------------------------------------------

procedure TIndexedBlendMode.NormalBlend(F: TIndexedAlpha; var B: TIndexedAlpha; MasterAlpha: Byte);
var
  aMaster        : Byte;
  fAlpha, bAlpha : Byte;
  fIndexed, bIndexed   : Byte;
  rAlpha, rIndexed  : Byte;
  BlendIndexed      : Word;
  tIndexed          : SmallInt;
