{ LibTiffDelphi
  This version is based on the one found in ImagingLib.
  The version here was then updated to the most recent libtiff and also enhanced,
  adapted and completely revised by Jacob Boerema.
}
...
const
  ...
  CLibTiffVersion = '4.0.7';        // The compiled libtiff version we are using.
  {$IFNDEF FPC}
  CCompiler       = 'Delphi';
  {$ELSE}
...
{$IFDEF MSWINDOWS}
// TODO: Check if we can change AnsiString to string!
...
// Warning JBIG has incompatible license IIRC.
